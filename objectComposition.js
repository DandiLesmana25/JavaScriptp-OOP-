...
const frontEndDeveloper = createFrontEndDeveloper('Aceng');
...
const backEndDeveloper = createBackEndDeveloper('Akum');
...
const devOpsDeveloper = createDevOps('mamang');
...
const fullStackDeveloper = createFullStackDeveloper('Aderai');
